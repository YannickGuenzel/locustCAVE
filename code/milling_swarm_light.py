...
class MyApp(ShowBase):
    ...
    def __init__(self):
        ...
        self.yPos = -100  # foward-backward   [cm]

        # VIRTUAL ANIMALS
        self.n_locust = 150  # total number
        ...
        # SKY
        self.setBackgroundColor(0, 0, 0.3)

        # LIGHT
        # Because this is a gaming engine, we have some nice shadow effects. Let's play around with those. Maybe I need
        # this for a talk at soe point :-)
        # --- Bonfire
        self.light_model = self.loader.loadModel('models/misc/sphere')
        self.light_model.setScale(1, 1, 1)
        self.light_model.setPos(0, 0, 5)
        ...
        for i in range(self.n_locust):
            ...
            self.locustActors[-1].setLight(plnp)
